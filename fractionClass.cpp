...
/*** Function add 
 * Compute the addition of 2 Fractions
 * Input: fractions F1 (calling object) and F2 (frac)
...
/*** Function add 
 * Compute the addition (Fraction + integer)
 * Input: a fraction F (calling object) and an integer N
 * Return: fraction = F + N
 */
...
/*** Function sub 
 * Compute the subtraction of 2 Fractions
 * Input: fractions F1 (calling object) and F2 (frac)
 * Return: fraction = F1 - F2
 */
...
/*** Function sub 
 * Compute the subtraction (Fraction - integer)
 * Input: a fraction F (calling object) and an integer N
 * Return: fraction = F - N
 */
...
/*** Function mul 
 * Compute the multiplication of 2 Fractions
 * Input: fractions F1 (calling object) and F2 (frac)
 * Return: fraction = F1 * F2
 */
...
/*** Function mul 
 * Compute the multiplication (Fraction * integer)
 * Input: a fraction F (calling object) and an integer N
 * Return: fraction = F * N
 */
...
/*** Function div 
 * Compute the division of 2 Fractions
 * Input: fractions F1 (calling object) and F2 (frac)
 * Return: fraction = F1 / F2
 */
...
/*** Function div 
 * Compute the division (Fraction / integer)
 * Input: a fraction F (calling object) and an integer N
 * Return: fraction  = F / N, if N != 0
 */
